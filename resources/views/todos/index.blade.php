...
<div class="flex justify-center border-b pb-4">
    ...
    <a class="mx-5 py-2 text-blue-400 cursor-pointer" href="/todos/create">
            ...
            <div>   
                ...
                if(confirm('are you sure you want to delete?')){
                 ...
                 class="fas fa-trash px-4 text-red-400 cursor-pointer"/>
                    <form style="display: none;" id="{{ 'form-delete-'.$todo->id }}" action="{{ route('todo.delete',$todo->id) }}" method="post">
                        @csrf
                        @method('delete')
                    </form>
